        ...
        <div className="container">
          ...
          <div className="cart">
            <div className="cart-item">
              ...
              <div className="cart-item__image"><img src="img/content/catalog-product-2.jpg" srcSet="img/content/catalog-product-2@2x.jpg 2x" width={55} height={130} alt="ЭлектроГитара Честер bass" />
              </div>
            ...
            <div className="cart-item">
              ...
              <div className="cart-item__image"><img src="img/content/catalog-product-4.jpg" srcSet="img/content/catalog-product-4@2x.jpg 2x" width={55} height={130} alt="СURT Z30 Plus" />
              </div>
              <div className="product-info cart-item__info">
